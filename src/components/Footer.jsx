                        ...
                        <div className="grid row-gap-10 mb-8 lg:grid-cols-6">
                            <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
                                <div>
                                    ...
                                    <ul className="mt-2 space-y-2">
                                        <li className="hover:text-white dark:hover:text-cyan-500">
                                            <Link
                                                href="/"
                            ...
                            <div className="md:max-w-md lg:col-span-2">
                                ...
                                <p className="mt-4 text-sm ">
                                    Bacon ipsum dolor amet short ribs pig
                                    sausage prosciuto chicken spare ribs salami.
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="flex items-center mt-4 space-x-4 sm:mt-0">
                                ...
                                >
                                    <svg
                                        viewBox="0 0 24 24"
                                        fill="currentColor"
                                        className="h-5 hover:text-cyan-500 font-semibold  cursor-pointer"
                                    >
                                ...
                                >
                                    <svg
                                        viewBox="0 0 30 30"
                                        fill="currentColor"
                                        className="h-6 hover:text-red-500 font-semibold  cursor-pointer"
                                    >
                                ...
                                >
                                    <svg
                                        viewBox="0 0 24 24"
                                        fill="currentColor"
                                        className="h-5 hover:text-blue-500 font-semibold  cursor-pointer"
                                    >
